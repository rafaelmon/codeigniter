...
//        boxMaxWidth:100,
        ...
        items: [ 
            {boxLabel: '<span style="background-color:#088A08; color:#FFF;">&nbsp;Menor&nbsp;</span>', name: 'rgCriticidad', inputValue: '3'}, 
   ...
   rmcSetCritCreateForm = new Ext.FormPanel({
        ...
        items: [{
                ...
                items:[{
                    ...
                    layout: 'form',
                    border:false,
                    items: [criticidadRmcRadios,invRmcFieldSet]
                    }
                ]
                }
        ],
    ...
    rmcSetCritCreateWindow= new Ext.Window({
        ...
        title: 'Definir la criticidad del RMC',
        closable:false,
        modal:true,
        width: 470,
        height: 300,
