...
ddpTopAprAuditoriaDataStore = new Ext.data.Store({
    id: 'ddpTopAprAuditoriaDataStore',
    name: 'ddpTopAprAuditoriaDataStore',
...
ddpTopAprAuditoriaColumnModel = new Ext.grid.ColumnModel(
    [   
        {
            header: '#',
            dataIndex: 'id',
...
//        }
   ...
   ddpTopAprAuditoriaGrid =  new Ext.grid.GridPanel({
        id: 'ddpTopAprAuditoriaGrid',
//        title: 'Historial de objetivo:',
        store: ddpTopAprAuditoriaDataStore,
        cm: ddpTopAprAuditoriaColumnModel,
        enableColLock:false,
