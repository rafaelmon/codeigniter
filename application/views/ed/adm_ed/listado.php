...
?>
	...
	var TAM_PAGINA=25;
	var CARPETA = "<?= site_url("ed/adm_ed")?>";
	...
	Ext.QuickTips.init();
        ...
        var edAdminDataStore;
        var edAdminBotonesAction;
        var edAdminColumnModel;
        var periodosFiltro;
        var buscadorEd;
        var edAdminListingEditorGrid;
	...
	include_once("editSupervisor.js");
	?>
