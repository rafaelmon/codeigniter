...
//	 include_once(PATH_BASE."js/ext-3.3.0/examples/ux/fileuploadfield/FileUploadField.js");
	...
	var CARPETA = "<?= site_url("admin/departamentos")?>";
	var LINK_GENERICO = "<?= site_url("genericos")?>";
	
	var DepartamentosDataStore;
        var gerenciasDSGrilla;
        var empresasDSGrilla
	var DepartamentosColumnModel;
	var DepartamentoCreateWindow;
	var DepartamentoCreateForm;
	var departamentoField;
	var abvField;
	var empresaCombo;
	var gerenciaCombo;
	var DepartamentosListingEditorGrid;
	var DepartamentoListingSelectedRow;
	...
	// Ventana y funciones Alta Departamento
	<?php
	include_once("AltaDepartamento.js");
	include_once("ModificaDepartamento.js");
	?>		
	...
	// Datos para la grilla de Departamentos
	<?php
