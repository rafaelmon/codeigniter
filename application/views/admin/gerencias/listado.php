...
//	 include_once(PATH_BASE."js/ext-3.3.0/examples/ux/fileuploadfield/FileUploadField.js");
	...
	var CARPETA = "<?= site_url("admin/gerencias")?>";
	var LINK_GENERICO = "<?= site_url("genericos")?>";
	
	var GerenciasDataStore;
	var GerenciasColumnModel;
	var GerenciaCreateWindow;
	var GerenciaCreateForm;
	var gerenciaField;
	var abvField;
	var empresaCombo;
	var GerenciasListingEditorGrid;
	var GerenciaListingSelectedRow;
	...
	// Ventana y funciones Alta Gerencia
	<?php
	include_once("AltaGerencia.js");
	?>		
	...
	// Datos para la grilla de Gerencias
	<?php
