...
?>        
    ...
    var CARPETA = "<?= site_url("cap/capacitaciones")?>";
    var LINK_GENERICO = "<?= site_url("genericos")?>";
    
    var capCapacitacionesPanel;
    var tareasGridPanel;
...
//        include_once(PATH_BASE."js/ext-3.3.0/SuperBoxSelect/SuperBoxSelect.js");
    ...
    include_once("grilla_tareas.js");
    include_once("grilla_participantes.js");
    include_once("alta_capacitacion.js");
    include_once("set_responsable.js");
