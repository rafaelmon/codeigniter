...
//	 include_once(PATH_BASE."js/ext-3.3.0/examples/ux/fileuploadfield/FileUploadField.js");
	...
	var CARPETA = "<?= site_url("it/areas_rpyc")?>";
	var LINK_GENERICO = "<?= site_url("genericos")?>";
	
	var areasDataStore;
	var areasColumnModel;
	var areaCreateWindow;
	var areaCreateForm;
	var areaField;
	var empresaCombo;
	var areasListingEditorGrid;
	var areaListingSelectedRow;
