//PANEL INFERIOR
gestionesDocsObsoletosDataStore = new Ext.data.Store({
    id: 'gestionesDocsObsoletosDataStore',
...
gestionesDocsObsoletosColumnModel = new Ext.grid.ColumnModel([
    {
        header: '#',
//        readOnly: true,
...
gestionesDocsObsoletosGrid =  new Ext.grid.GridPanel({
    id: 'gestionesDocsObsoletosEditorGrid',	  
    store: gestionesDocsObsoletosDataStore,
    cm: gestionesDocsObsoletosColumnModel,
    enableColLock:false,	 
    viewConfig: {
        forceFit: false
    },      
...
obsoletosInferiorPanel = new Ext.Panel(
{
        collapsible: true,
        collapsed:true,
        split: true,
        ...
        layout: 'fit',
        items : [gestionesDocsObsoletosGrid]
});
