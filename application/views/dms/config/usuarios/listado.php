...
//	 include_once(PATH_BASE."js/ext-3.3.0/examples/ux/fileuploadfield/FileUploadField.js");
	...
	var TAM_PAGINA=25;
	var CARPETA = "<?= site_url("dms/dms_usuarios")?>";
	var LINK_GENERICO = "<?= site_url("genericos")?>";
	
        //grilla
        var usuariosRolesDataStore;
        var habilitadaCheck;
        var editorCheck;
        var revisorCheck;
        var aprobadorCheck;
        var publicadorCheck;
        var usuariosRolesColumnModel;
        var buscadorUsuarioRoles;
        var usuariosRolesListingEditorGrid;
	//AltaUsuarioDMS
        var usuariosDS;
	var usuarioCombo;
	var resultTpl;
	var usuarioCombo;
	var agregaUsuarioForm;
	...
	<?php
	include_once("AltaUsuarioDMS.js");
	?>		
