...
class Gerencias extends CI_Controller
{
	...
	public function index()
	{
            ...
            $this->load->view('admin/gerencias/listado',$variables);
	}
    ...
    //                            echo "<pre>".print_r($campos,true)."</pre>";
                    ...
                    $listado = $this->gerencias->listado($start, $limit, $filtro, $campos, $sort, $dir);
                    echo $listado;
                }
                else
	...
	public function modificar()
	{
            if ($this->permisos['Modificacion'])
            {
                    ...
                    if(!$this->gerencias->edit($_POST["id"],$datos))
                        echo 0;
                    else
                        echo 1;
            }
