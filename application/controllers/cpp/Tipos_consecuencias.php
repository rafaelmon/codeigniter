<?php
class Tipos_consecuencias extends CI_Controller
{
    private $modulo=45;
    private $user;
    private $permisos;
...
//            echo "<pre>Origen".print_r($this,true)."</pre>";
	...
	public function index()
	{
            ...
            $this->load->view('cpp/tipos_consecuencias/listado',$variables);
	}
	...
	public function listado()
	{
            ...
            {
                $this->load->model('cpp/cpp_tipos_consecuencias_model','tipos_consecuencias',true);
                ...
                $listado = $this->tipos_consecuencias->listado($start, $limit, $sort,$dir,$busqueda,$campos);
                echo $listado;
            }
            else
        ...
        public function insert()
	{
            if ($this->permisos['Alta'])
            {
                ...
                $datos['tipo_consecuencia'] = $this->input->post("tipo_consecuencia");
                $datos['descripcion'] = $this->input->post("descripcion");
//                echo "<pre>".print_r($datos,true)."</pre>";die();
                if ($datos['tipo_consecuencia'] != '')
                {
                    $this->load->model('cpp/cpp_tipos_consecuencias_model','tipos_consecuencias',true);	
                    if ($this->tipos_consecuencias->insert($datos))
                        echo 1;
                    else
                        echo 0;
                }
        ...
        public function update()
	{
            ...
            {
                $id = $this->input->post("id_tipo_consecuencia");
                ...
                if (count($campos)>0)
                {
                    ...
                    if ($this->tipos_consecuencias->update($id,$datos))
                    {
                        echo 1;
                    }
                    else
