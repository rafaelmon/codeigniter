...
//            echo "<pre>Origen".print_r($this,true)."</pre>";
	...
	public function index()
	{
            ...
            $this->load->view('cpp/productos/listado',$variables);
	}
	...
	public function listado()
	{
            if ($this->permisos['Listar'])
            {
                ...
                $listado = $this->productos->listado($start, $limit, $sort,$dir,$busqueda,$campos);
                echo $listado;
            }
            else
...
//                echo "<pre>".print_r($indice,true)."</pre>";
//                echo "<pre> Valores. ".print_r($indice,true)."</pre>";die();
                if (count($campos)>0)
                {
