...
//            echo $this->db->last_query();
    ...
    {
        if ($this->db->insert("cpp_sectores",$datos))
        {
    ...
    function update($id, $datos)
    {
        ...
        if ($this->db->update("cpp_sectores",$datos))
            return true;
        else
            return false;
    }
